...
# - TAB: Move down and toggle selection
...
zstyle ':fzf-tab:*' fzf-flags --multi --bind='ctrl-space:toggle,tab:down+toggle,shift-tab:up,ctrl-a:select-all,ctrl-d:deselect-all,ctrl-j:down,ctrl-k:up'

# Specific multi-select for kill command (processes)
zstyle ':fzf-tab:complete:kill:argument-rest' fzf-flags --multi --bind='ctrl-space:toggle,tab:down+toggle,shift-tab:up,ctrl-a:select-all,ctrl-d:deselect-all'

# Multi-select for git branch operations
zstyle ':fzf-tab:complete:git-checkout:*' fzf-flags --multi --bind='ctrl-space:toggle,tab:down+toggle,shift-tab:up,ctrl-a:select-all,ctrl-d:deselect-all'
zstyle ':fzf-tab:complete:git-branch:*' fzf-flags --multi --bind='ctrl-space:toggle,tab:down+toggle,shift-tab:up,ctrl-a:select-all,ctrl-d:deselect-all'

# Multi-select for docker operations
zstyle ':fzf-tab:complete:docker-stop:*' fzf-flags --multi --bind='ctrl-space:toggle,tab:down+toggle,shift-tab:up,ctrl-a:select-all,ctrl-d:deselect-all'
zstyle ':fzf-tab:complete:docker-rm:*' fzf-flags --multi --bind='ctrl-space:toggle,tab:down+toggle,shift-tab:up,ctrl-a:select-all,ctrl-d:deselect-all'
