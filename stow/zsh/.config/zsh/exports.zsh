...
# LS_COLORS for file listings (optimized for light backgrounds)
# Using vivid to generate Catppuccin Latte colors if available, otherwise fallback
if command -v vivid >/dev/null 2>&1; then
  export LS_COLORS="$(vivid generate catppuccin-latte)"
else
  # Fallback LS_COLORS for light theme (Catppuccin Latte inspired)
